...
function content_568df36928b267_25947078 ($_smarty_tpl) {
?>
...
<title>两扣双开衩平驳头斜兜男士西服套装3312/纯藏青色人字纹/羊毛+涤纶</title>
...
<div class="block clearfix">
	<div class="layout_4">
        ...
        <div class="layout_right"> 
            ...
            <code>&gt;</code>  两扣双开衩平驳头斜兜男士西服套装3312/纯藏青色人字纹/羊毛+涤纶
                 <div class="blank"></div>
                    	...
                    	<div class="polo_gallery f_l">
					      ...
					      <div class="goods_gallery">
                                ...
                                <div class="gcontent" id="goods_gallery" style="overflow: hidden; width: 80px; height: 400px;">
                                	<table>
                                                                        <tbody><tr>
                                    <td><div class="curr"><a href="#" onmouseover="sw_goodsimg(this)"><img src="data/images/201212/19/thumb_aifwnt.JPG" alt="两扣双开衩平驳头斜兜男士西服套装3312/纯藏青色人字纹/羊毛+涤纶"></a></div></td>
                                    </tr>
                                                                        </tbody></table>
                                </div>
                    	...
                    	<div class="goods_pics_polo f_l">
                        	<div class="goods_big_img" style="position:relative; border:1px solid #e6e6e6">
                             <a href="#" class="jqzoom" id="picbox" style="outline-style: none; cursor: crosshair; display: block; height: 400px; width: 300px;" title="">                        	
                              <img src="data/images/201212/19/goods_aifwnt.JPG" alt="两扣双开衩平驳头斜兜男士西服套装3312/纯藏青色人字纹/羊毛+涤纶" class="goodsimg" id="goods_bimg" style="position: absolute; top: 0px; left: 0px;" title="">                             </a>                             </div>
     ...
     <form action="javascript:addToCart(315)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY">
         ...
         两扣双开衩平驳头斜兜男士西服套装3312/纯藏青色人字纹/羊毛+涤纶
			</div>
      <ul>
       ...
       BL2012121939587
                   ...
                   <li class="clearfix">
       <dd>
       <strong>本店售价：</strong><font class="shop1" id="ECS_SHOPPRICE">￥799.00元</font>
        </dd>
      </li>
                     <li class="clearfix">
       <dd>
       <strong style="color:#999">市场价格：</strong><font class="market">￥1598.00元</font>
         </dd>
      </li>
...
<div style="_padding-top:17px;">
      ...
      <div class="f_l" style="padding-left:25px; border:none">
       <strong style=" font-weight: bold; color:#666; ">商品总价：</strong><font id="ECS_GOODS_AMOUNT" class="shop">￥799.00元</font>
      </div>
    <div class="f_r">
      <a href="flow.php?act=buy&goods_id=1&num=1"><img src="./view/front/images/bnt_cat.gif"></a>
