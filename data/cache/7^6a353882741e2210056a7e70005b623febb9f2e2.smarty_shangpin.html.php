...
function content_568d4d5596ac59_29488145 ($_smarty_tpl) {
?>
                    	...
                    	<div class="polo_gallery f_l">
					      ...
					      <div class="goods_gallery">
                                ...
                                <div class="gcontent" id="goods_gallery" style="overflow: hidden; width: 80px; height: 400px;">
                                	<table>
                                                                        <tbody><tr>
                                    <td><div class="curr"><a href="#" onmouseover="sw_goodsimg(this)"><img src="data/images/201212/19/thumb_wcri9z.JPG" alt="两扣双开衩平驳头斜兜男士西服套装3312/纯藏青色人字纹/羊毛+涤纶"></a></div></td>
                                    </tr>
                                                                        </tbody></table>
                                </div>
                    	...
                    	<div class="goods_pics_polo f_l">
                        	<div class="goods_big_img" style="position:relative; border:1px solid #e6e6e6">
                             <a href="#" class="jqzoom" id="picbox" style="outline-style: none; cursor: crosshair; display: block; height: 400px; width: 300px;" title="">                        	
                              <img src="data/images/201212/19/goods_wcri9z.JPG" alt="两扣双开衩平驳头斜兜男士西服套装3312/纯藏青色人字纹/羊毛+涤纶" class="goodsimg" id="goods_bimg" style="position: absolute; top: 0px; left: 0px;" title="">                             </a>                             </div>
     ...
     <form action="javascript:addToCart(315)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY">
      ...
      <ul>
       ...
       BL2012121936338
                   ...
                   <li class="clearfix">
       <dd>
       <strong>本店售价：</strong><font class="shop1" id="ECS_SHOPPRICE">￥567.00元</font>
        </dd>
      </li>
                     <li class="clearfix">
       <dd>
       <strong style="color:#999">市场价格：</strong><font class="market">￥1324.00元</font>
         </dd>
      </li>
...
<div style="_padding-top:17px;">
      ...
      <div class="f_l" style="padding-left:25px; border:none">
       <strong style=" font-weight: bold; color:#666; ">商品总价：</strong><font id="ECS_GOODS_AMOUNT" class="shop">￥567.00元</font>
      </div>
    <div class="f_r">
      <a href="flow.php?act=buy&goods_id=7&num=1"><img src="./view/front/images/bnt_cat.gif"></a>
